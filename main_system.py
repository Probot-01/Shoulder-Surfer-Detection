...
# Screenshot: press 's'
>>>>>>> 30afecaba40afd3a9f4a5b5af8d797da90fad457
# ============================================================================
...
_manual_override  = False    # True = user pressed 'p' to force toggle
    ...
    try:
        while not _should_quit:
            ...
            if protector_ok and protector is not None:
                ...
                # protector.update() calls root.update() which processes
                # all pending tkinter events (redraws, cursor polls, etc.)
